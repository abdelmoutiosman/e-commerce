                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        ...
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> {{$setting->phone_number}}</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> {{$setting->gmail}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{$setting->linkend_in_link}}"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="{{$setting->youtube_link}}"><i class="fa fa-youtube"></i></a></li>
                            <li><a href="{{$setting->google_link}}"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            ?>
                            @if($customer_id != NULL)
                                <li><a href="{{url('/customer-account',['customer_id'=>$customer_id])}}"><i class="fa fa-user"></i> Account</a></li>
                            @else
...
{{--                            <li><a href="#"><i class="fa fa-star"></i> Wishlist</a></li>--}}
                            ...
                            <li><a href="{{url('/show-cart')}}"><i class="fa fa-shopping-cart"></i> Cart <span class="label label-warning" style="vertical-align: super">{{Cart::content()->count()}}</span></a></li>

                            @if($customer_id != NULL)
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <i class="fa fa-angle-down"></i> {{Session::get('customer_name')}} <img src="{{asset('frontend/images/default.png')}}" class="user-image" style="width: 30px;height: 30px">
                                    </a>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            @else
                                <li><a href="{{url('/login-checkout')}}">Checkout</a></li>
                            @endif

                            <li><a href="{{url('/show-cart')}}">Cart <span class="label label-warning" style="vertical-align: super">{{Cart::content()->count()}}</span></a></li>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        ?>
                                    ...
                                    <?php } ?>
                                        <div class="col-sm-4">
                                        <h1><span>{{$setting->web_name}}</span></h1>
                                        <h2>Ladias Shopping Bags</h2>
                                        <p>{{$setting->description}}</p>
                                        <a type="button" class="btn btn-default get" href="{{url('/all-products')}}">Get it now</a>
                                    </div>
                                    <div class="col-sm-8">
                                        <img src="{{asset($slider->slider_image)}}" class="girl img-responsive" alt="" style="width: 80%;height: 200px"/>
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{url('/product-by-category',$category->id)}}">{{$category->category_name}}</a></h4>
                            </div>
                        </div>
                            @endforeach
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{url('/product-by-brand',$brand->id)}}"> <span class="pull-right">( {{$brands->count()}} )</span>{{$brand->manufacture_name}}</a></li>
                                    @endforeach
                            </ul>
                        </div>
                    </div><!--/brands_products-->
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>{{$setting->web_name}}</span></h2>
                        <p>{{$setting->description}}</p>
                    </div>
                </div>
                <div class="col-sm-7">
